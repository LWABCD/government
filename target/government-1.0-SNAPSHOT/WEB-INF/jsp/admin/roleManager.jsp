...
<script type="text/javascript">
    ...
    layui.extend({
    ...
    }).use([ 'jquery', 'layer', 'form', 'table','dtree' ,'tree' ], function() {
        var $ = layui.jquery;
        ...
        tableIns=table.render({
            ...
            ,cols: [[   //列表数据
                ...
                ,{field:'userCount', title:'人数',align:'center'}
                ,{field:'userNames', title:'用户名',align:'center'}
            ...
            mainIndex=layer.open({
                ...
                success:function(index){
                    ...
                    menuTree = dtree.render({
                        ...
                        //url: "${ctx}/resources/layui_ext/json/case/asyncTree4.json"
                    });
                }
            });
        }
