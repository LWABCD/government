	    ...
	    layui.use([ 'jquery', 'layer', 'form', 'table','laydate'  ], function() {
			...
			//渲染数据表格
			 tableIns=table.render({
			    ...
			    ,url:'${ctx}/logInfo/loadAllLogInfo' //数据接口
			      ...
			      ,{field:'logintime', title:'登录时间',align:'center',
						 templet: function (e) {
							 if (e.logintime == null) {
								 ...
								 return layui.util.toDateString(e.logintime, "yyyy-MM-dd HH:mm:ss");
							 }
						 }
					 }
			...
			$("#doSearch").click(function(){
				...
				tableIns.reload({
					url:"${ctx}/logInfo/loadAllLogInfo?"+params,
					page:{curr:1}
		   ...
		   table.on('tool(logInfoTable)', function(obj){
			...
			function deleteBatch(){
			    ...
			    layer.confirm('真的删除选中的这些日志吗', function(index){
				       //向服务端发送删除指令
				       $.post("${ctx}/logInfo/deleteBatchLogInfo",params,function(res){
				    	   layer.msg(res.msg);
				    	    //刷新数据 表格
							tableIns.reload();
				       })
