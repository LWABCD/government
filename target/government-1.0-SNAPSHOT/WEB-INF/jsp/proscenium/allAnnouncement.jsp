    ...
    <div id="MainCenter" align="center" class="MainCenter">
        <div id="content" class="Sub" style="padding-left: 200px">
            <div class="NewContainer770">
                <div class="BoxHeader">
                    <div class="BoxHeader-center MarginTop10">所有公告<a href="javascript:;" onclick="self.location=document.referrer;"><<</a></div>
                </div>
                <div class="Slot">
                    <!-- 数据表格开始 -->
...
<script>
        ...
        $.ajax({
            ...
            layui.use('table', function(){
                ...
                table.render({
                    ...
                    // } //开启分页
                    ,cols: [[ //表头
                        {field: 'title', title: '公告标题', align: 'center', width: '460'}
    ...
    layui.use([ 'jquery', 'table'], function() {
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(layEvent === 'edit'){ //编辑
                window.location.href="/government/index/announcementDetail?aid="+data.aid;
            }
        });
    })
