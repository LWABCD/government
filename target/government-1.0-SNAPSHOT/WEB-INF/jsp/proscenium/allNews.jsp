    ...
    <div id="MainCenter" align="center" class="MainCenter">
        <div id="content" class="Sub" style="padding-left: 200px">
            <div class="NewContainer770">
                <div class="BoxHeader">
                    <div class="BoxHeader-center MarginTop10">所有新闻<a href="javascript:;" onclick="self.location=document.referrer;"><<</a></div>
                </div>
                <div class="Slot">
                    <!-- 数据表格开始 -->
...
<script>
            ...
            success:function(datas){
                layui.use('table', function(){
                    ...
                    table.render({
                        ...
                        // } //开启分页
                        ,cols: [[ //表头
                            {field: 'title', title: '新闻标题', align: 'center', width: '460'}
    ...
    layui.use([ 'jquery', 'table'], function() {
        ...
        table.on("toolbar(userTable)", function (obj) {
            switch (obj.event) {
                case 'add':
                    window.location.href="/government/pLeaderEmail/toLeaderEmail";
                    break;
            }
            ;
        });
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(layEvent === 'edit'){ //编辑
                window.location.href="/government/index/newsDetail?nid="+data.nid;
            }
        });
    })
