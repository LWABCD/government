    ...
    <div id="MainCenter" align="center" class="MainCenter">
        <div id="content" class="Sub" style="padding-left: 200px">
            <div class="NewContainer770">
                <div class="BoxHeader">
                    <div class="BoxHeader-center MarginTop10">所有网站<a href="javascript:;" onclick="self.location=document.referrer;"><<</a></div>
                </div>
                <div class="Slot">
                    <!-- 数据表格开始 -->
...
<script>
    ...
    layui.use([ 'jquery', 'table'], function() {
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(layEvent === 'edit'){ //编辑
                window.location.href="/government/pLeaderEmail?nid="+data.nid;
            }
        });
    })
