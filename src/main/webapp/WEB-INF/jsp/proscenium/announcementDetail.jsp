...
<div id="MainCenter" align="center" class="MainCenter">
		 <div id="content" class="Sub" style="padding-left: 200px">
				<div class="NewContainer770">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">公告详情<a href="javascript:;" onclick="self.location=document.referrer;"><<</a></div>
					</div>
					<div class="Slot">
						<table id="table" align="center" width="100%" border="0" align="center">
						    <tr style="height: 100px">
								<td align="center"><span style="font-size: x-large">${requestScope.announcement.title}</span></td>
						    </tr>
						    <tr>
						        <td style="padding-left: 50px;">来源:${requestScope.announcement.origin}<span style="float: right;padding-right:100px ">阅读:${requestScope.announcement.readnumber}</span></td>
						    </tr>
							<tr>
