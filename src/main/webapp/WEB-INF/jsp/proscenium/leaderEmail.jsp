    ...
    <div id="MainCenter" align="center" class="MainCenter">
        <div id="content" class="Sub" style="padding-left: 200px">
            <div class="NewContainer770">
                <div class="BoxHeader">
                    <div class="BoxHeader-center MarginTop10">所有来信<a href="javascript:;" onclick="self.location=document.referrer;"><<</a></div>
                </div>
                <div class="Slot">
                    <button type="button" class="layui-btn layui-btn-sm"><a href="/government/pLeaderEmail/toLeaderEmailEdit" target="_blank">我要写信</a></button>
                    <!-- 数据表格开始 -->
...
<script>
    ...
    function getdata(pageNow){
        $.ajax({
            url:'/government/pLeaderEmail/leaderemails',
            ...
            success:function(datas){
                layui.use('table', function(){
                    ...
                    table.render({
                        ...
                        // } //开启分页
                        ,cols: [[ //表头
                            {field: 'title', title: '信件标题', align: 'center', width: '460'}
                            , {field: 'sendtime', title: '时间', align: 'center', width: '246',
                                templet: function (e) {
                                    if (e.sendtime == null) {
                                        return '';
                                    } else {
    ...
    layui.use([ 'jquery', 'table'], function() {
        ...
        table.on('tool(userTable)', function(obj){
            ...
            if(layEvent === 'edit'){ //编辑
                $.ajax({
                    url:'/government/pLeaderEmail/leaderEmailDetail',
                    type:'post',
                    data:{'leid':data.leid},
                    success:function(json){
                        if(json.code==1){
                            window.location.href="${pageContext.request.contextPath}/pLeaderEmail/toLeaderEmailDetail";
                        }
                        else{
                            layer.alert("查看失败");
                        }
