...
<div class="layui-row layui-col-space10">
    <div class="layui-col-lg6 layui-col-md6">
        <blockquote class="layui-elem-quote title">最新日志 <i class="layui-icon layui-red">&#xe756;</i></blockquote>
...
<script type="text/javascript">
    ...
    function getLangDate(){
        ...
        document.getElementById("nowTime").innerHTML = "你好，${user.username}，欢迎登录！当前时间为： "+newDate+"　"+week;
