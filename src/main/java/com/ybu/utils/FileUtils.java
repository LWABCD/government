...
//	}
	...
	public static void saveText(String content, String textFilePath) {
		String filePath="G://governmentfile//"+textFilePath;
	...
	public static  ResponseEntity<Object> downloadFile(HttpServletResponse response, String path, String oldName) {
		...
		File file=new File(FileUtils.PATH,path);
		//5,判断文件是否存在
		if(file.exists()) {
			try {
				try {
	...
	public static String readText(String content){
		String text="";
		String textFilePath="G://governmentfile//"+content;
